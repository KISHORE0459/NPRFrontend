...
const UserExitDetail = ({ user }) => {
  return (
    <div className="w-78 md:w-92 min-h-36 h-fit shadow-lg shadow-gray-300 flex flex-col gap-2 p-3 hover:cursor-pointer hover:shadow-gray-400 rounded">
      ...
      <div className="flex flex-row gap-2 text-[#374151] items-center">
        <IoCarSportOutline />
